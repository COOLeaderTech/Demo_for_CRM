...
<div class="match-results">
  <div class="match-group">
    ...
    if (activeMode === 'reporting') {
        // Broker Overview (main report)
        if (wantsBrokerReport || wantsRegenerate || selectedReportingMode === 'broker-overview') {
            return generateBrokerReport(wantsRegenerate);
        }

        // Forecast
        if (selectedReportingMode === 'forecast') {
        ...
        // Live Activity
        if (selectedReportingMode === 'live-activity') {
